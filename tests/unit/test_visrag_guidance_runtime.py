...
def _write_runtime_rules(root: Path) -> None:
    ...
    records = [
        {
            "chunk_id": "pattern_line",
            "source_id": "test_source",
            "source_kind": "chart_pattern",
            "title": "Line trend pattern",
            "text": "Use a multi-series line chart for temporal trends by category.",
            "metadata": {"retrieval_text": "trend over time line temporal x axis sales region category", "task": "trend", "chart_family": "line"},
        },
        {
            "chunk_id": "legend_rule",
            "source_id": "test_source",
            "source_kind": "readability_rule",
            "title": "Legend required",
            "text": "Keep a visible legend when color encodes the requested grouping.",
            "metadata": {"retrieval_text": "color category grouping visible legend required tooltip not enough", "task": "trend", "chart_family": "line"},
        },
        {
            "chunk_id": "scale_rule",
            "source_id": "test_source",
            "source_kind": "scale_plot_area_rule",
            "title": "Plot area policy",
            "text": "For line charts, avoid forcing zero if it compresses the main trend.",
            "metadata": {"retrieval_text": "line chart scale zero false outlier compressed plot area", "chart_family": "line"},
        },
        {
            "chunk_id": "vlm_rule",
            "source_id": "test_source",
            "source_kind": "vlm_readability_rule",
            "title": "Static PNG visibility",
            "text": "Required fields must be visible in the static PNG; tooltip-only is not enough.",
            "metadata": {"retrieval_text": "static png required fields visible tooltip not enough axis legend"},
        },
        {
            "chunk_id": "domain_rule",
            "source_id": "test_source",
            "source_kind": "domain_semantics_rule",
            "title": "HbA1c semantics",
            "text": "HbA1c is a clinical biomarker; show units and avoid diagnostic claims from a chart alone.",
            "metadata": {"retrieval_text": "hba1c biomarker clinical diabetes measure treatment group", "domain": "medicine"},
        },
    ]
