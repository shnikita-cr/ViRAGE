...
def test_reasoner_service_builds_insight_candidates_from_visual_facts(visual_facts_result, analysis_rubric,
                                                                      runtime) -> None:
    ...
    assert "peak" in result.insight_candidates[0].statement.lower() or "sales" in result.insight_candidates[
        0].statement.lower()
