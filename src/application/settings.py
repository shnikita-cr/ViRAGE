...
class ViRAGESettings(BaseModel):
    ...
    visrag_top_k_chart_patterns: int = Field(default=2, ge=0)
    visrag_top_k_readability_rules: int = Field(default=2, ge=0)
    visrag_top_k_scale_plot_area_rules: int = Field(default=1, ge=0)
    visrag_top_k_vlm_readability_rules: int = Field(default=2, ge=0)
    visrag_top_k_domain_semantics_rules: int = Field(default=1, ge=0)
