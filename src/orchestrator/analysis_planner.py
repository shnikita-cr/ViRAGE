...
class AnalysisPlanner:
    ...
    def _prompt(
        ...
        return (
            ...
            "12. For image quality overview requests, use ranking_strategy='full_distribution' when no problematic-item ranking is requested.\n"
            "13. For problematic, worst, outlier, low-quality, or poor-quality item requests, choose one exact problematic-item ranking_strategy: "
            "top_n_highest_severity, top_n_lowest_metric, top_n_highest_metric, or extremity_from_typical. Do not omit ranking_strategy.\n"
            "14. Do not put different-scale metrics on one shared quantitative axis. Plan normalized severity or independent panels.\n\n"
