...
class VegaLitePlotDrawingService(BaseService):
    ...
    def invoke(self, spec_validation: SpecValidationResult, run_id: str,
        ...
        runtime.save_json_artifact('artifacts/vega_lite_render_spec.json', spec_with_data, run_id=run_id)
        ...
        runtime.save_json_artifact('artifacts/rendered_scenegraph_raw.json', scenegraph, run_id=run_id)
